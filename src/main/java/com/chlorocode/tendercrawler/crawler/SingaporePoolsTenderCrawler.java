...
public class SingaporePoolsTenderCrawler extends Crawler {
    ...
    final String URL = "http://www.singaporepools.com.sg/en/tnq/Pages/tendernotice.aspx";
    final int SOURCE_ID = 8;

    public void run() {
        logger.info("Starting Singapore Pools Tender Crawler");
        ...
        logger.info("Ending Singapore Pools Tender Crawler");
    }
}
